                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('${_cartItems.length} sản phẩm', style: const TextStyle(fontSize: 13, color: Colors.grey)),
                        ],
                      ),
                      const SizedBox(height: 16),

                      // Product List
                      ..._cartItems.map((item) => _buildProductItem(item, formatCurrency, primaryColor)),
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildSummaryRow('Tạm tính (${_cartItems.length} sản phẩm)', formatCurrency.format(_totalPrice)),
                            const SizedBox(height: 12),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    Text(formatCurrency.format(_totalPrice), style: const TextStyle(fontSize: 22, fontWeight: FontWeight.bold, color: primaryColor)),
